...
using System.Linq;
        ...
        public class NVPAPICaller
        {
            ...
            public string APIUsername = "ravinkumar120894-facilitator_api1.gmail.com";
            private string APIPassword = "DAWKR7FY9YJX22NN";
            private string APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31AjzawvENuIK9DwEAt4KOrjg8Uj8v";
            ...
            public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
            {
                ...
                string returnURL = "https://localhost:7958/Checkout/CheckoutReview.aspx";
                string cancelURL = "https://localhost:7958/Checkout/CheckoutCancel.aspx";
                ...
                using (CruiseReservation.Logic.ShoppingCartActions myCartOrders = new CruiseReservation.Logic.ShoppingCartActions())
                {
                    List<CartItem> myOrderList = myCartOrders.GetCartItems();

                    for (int i = 0; i < myOrderList.Count; i++)
                    {
                        encoder["L_PAYMENTREQUEST_0_NAME" + i] = myOrderList[i].Tour.TourName.ToString();
                        encoder["L_PAYMENTREQUEST_0_AMT" + i] = myOrderList[i].Tour.UnitPrice.ToString();
